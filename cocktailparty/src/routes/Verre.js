    ...
    <div className="Verre">
      ...
      <div className="intro">
        <p>
          ...
          taille lors d'un apéro, le verre choisi pour le servir aussi ! Il est
          un facteur clé pour améliorer l'expérience de consommation. De
      ...
      <div className="margarita">
        ...
        <div className="texteVerre">
          ...
          <p>
            ...
            verre à Martini : un verre avec un diamètre qui change de largeur au
            milieu du bol (un verre à 2 étages). Il permet de garder les
      ...
      <div className="flute">
        ...
        <div className="texteVerre">
          ...
          <p>
            ...
            la boisson qui l'emplit. Souvent utilisée pour servir du champagne,
